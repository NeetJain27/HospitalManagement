...
class Hospital:
    def __init__(self,root) :
        ...
        comNameTablet=ttk.Combobox(DataframeLeft,font=("arial", 13, "bold"), width=41)
        comNameTablet['value']=("Paracetamol","Ibuprofen","Amoxicillin","Omeprazole","Lisinopril","Atorvastatin","Metformin")
        ...
        btnPrescription=Button (Buttonframe,  text="Prescription", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
        btnPrescription.grid(row=0, column=0)
       
        btnPrescriptionData=Button (Buttonframe,  text="Presciption Data", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
        btnPrescriptionData.grid(row=0, column=1)
       
        btnUpdate=Button (Buttonframe, text="Update", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
        btnUpdate.grid(row=0, column=2)
       
        btnDelete=Button (Buttonframe, text="Delete", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
        btnDelete.grid(row=0, column=3)
       
        btnClear=Button (Buttonframe, text="Clear", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
        btnClear.grid(row=0, column=4)
       
        btnExit=Button (Buttonframe, text="Exit", bg="orange", fg="white", font=("arial", 12, "bold"), width=24, padx=2, pady=13)
